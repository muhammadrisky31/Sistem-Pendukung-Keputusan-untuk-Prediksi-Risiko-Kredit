            ...
            <div class="card-body">
                ...
                <form action="{{ url('/predict') }}" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="pendapatan">Pendapatan Orang (IDR):</label>
                            <input
                                type="number"
                                id="pendapatan"
                                name="pendapatan"
                        ...
                        <!-- 5. Tujuan Peminjaman -->
                        <div class="form-group">
                            <label class="form-label" for="tujuan_pinjaman">Tujuan Peminjaman:</label>
                            <div class="select-wrapper">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="suku_bunga">Suku Bunga Pinjaman (%):</label>
                            <input
                                type="number"
                                id="suku_bunga"
                                name="suku_bunga"
                        ...
                        <div class="form-group">
                            <label class="form-label" for="status_pinjaman">Status Pinjaman (saat ini):</label>
                            <div class="select-wrapper">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="persen_pinjaman">Persentase Pinjaman dari Pendapatan:</label>
                            <input
                                type="number"
                                id="persen_pinjaman"
                        ...
                        <div class="form-group">
                            <label class="form-label" for="default_kredit">Default di Catatan Kredit (riwayat):</label>
                            <div class="select-wrapper">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="lama_kredit">Lama Catatan Kredit (tahun):</label>
                            <input
                                type="number"
                                id="lama_kredit"
                                name="lama_kredit"
